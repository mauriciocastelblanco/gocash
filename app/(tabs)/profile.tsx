...
import { View, Text, StyleSheet, ScrollView, Platform, TouchableOpacity, Modal, TextInput, Alert, ActivityIndicator } from "react-native";
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.dark ? '#1C1C1E' : '#FFF' }]}>
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={[styles.modalButton, styles.cancelButton, { backgroundColor: theme.dark ? '#2C2C2E' : '#F2F2F7' }]}
                onPress={() => {
